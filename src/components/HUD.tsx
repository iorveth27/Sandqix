...
export function HUD({ isVisible, capturedPercent, lives, level, score, onPause }: HUDProps) {
  return (
    <AnimatePresence>
      {isVisible && (
        <motion.div
        ...
        >
          ...
          <div className="absolute top-4 left-0 right-0 flex justify-center items-center gap-3 px-4 pointer-events-none">
            ...
            {/* Progress bar pill */}
            <div
              className="flex flex-col gap-1 px-3 py-2 rounded-2xl pointer-events-auto"
              style={{
                background: 'rgba(255,255,255,0.08)',
                backdropFilter: 'blur(12px)',
                WebkitBackdropFilter: 'blur(12px)',
            ...
            >
              ...
              <div className="flex items-center gap-2">
                ...
                <span
                  ...
                  style={{
                    color: '#fde68a',
                    textShadow: '0 0 6px rgba(245,166,35,0.8)',
                    minWidth: '32px',
                  }}
                >
                  LV {level}
                ...
                <div className="relative flex-1" style={{ minWidth: '120px' }}>
                  ...
                  >
                    <span style={{ fontSize: 36, lineHeight: 1, textShadow: '0 2px 6px rgba(180,120,0,0.9), 0 0 14px rgba(255,200,0,0.5), 0 0 28px rgba(255,200,0,0.3)' }}>⭐</span>
                  </div>
